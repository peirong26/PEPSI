...
class MetricLogger(object):
    ...
    def log_every(self, iterables, max_len, probs, epoch=None, header=None, is_test=False, modality='', train_limit=None, test_limit=None):
        ...
        for i in range(max_len):
            ...
            try:
                yield curr_dataset, next(generator_dict[curr_dataset]) 
