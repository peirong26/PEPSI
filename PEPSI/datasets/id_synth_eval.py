...
class IDSynthEval(Dataset): 
    ...
    def __init__(self, args, data_dir, device='cpu'): 
        ...
        self.ct_prob = args.base_test_generator.ct_prob
...
class DeformIDSynthEval(IDSynthEval):
    ...
    def _getitem_from_id(self, idx):
        ...
        subjects = {'name': os.path.basename(self.names[idx]).split(".")[0], 'image_orig': I_orig[None], 'aff': aff, 'loc_idx': loc_idx, 'shp': torch.tensor(shp)}
        return subjects, samples 
